...
namespace Jiaparts.LocalStorage
{
    public class SQLite
    {
        ...
        //    }
        //}
        public delegate void SQLiteErrorHandler(object sender , Exception ex);
        /// <summary>
        ...
        public class SQLiteConn : IDisposable
        {
            ...
            //private object dbSyncLock = new object();
            ...
            //    }
            //}
            public static event SQLiteErrorHandler OnSQLiteError = null;
            ...
            //public SQLiteConn(string databaseFile)
            //    : base(databaseFile, null)
            //{ 
            ...
            /// </param>
            public SQLiteConn(string databaseFile, string password)
            {
                ...
                {
                    throw new SQLiteException("please set SQLiteConnection.DatabaseFile " + DatabasePath);
                }
                DatabasePath = Path.Combine(AppPath, databaseFile);

                //byte[] utf8bytes = System.Text.Encoding.Default.GetBytes(DatabasePath);
                //DatabasePath = System.Text.Encoding.UTF8.GetString(utf8bytes); 
              
                SysUtility.SafeCreateFileDirectory(DatabasePath);

                //Logger.Error(DatabasePath);
                ...
                //{
                //    throw new SQLiteException("Could not open database file: " + DatabasePath);
                //}
                _open = true;
            ...
            public TimeSpan BusyTimeout
            {
                ...
                set
                {
                    ...
                    //{
                        this.Connection.DefaultTimeout = (int)_busyTimeout.TotalMilliseconds;
            ...
            public int CreateTable<T>()
            {
                ...
                {
                    tableExists = true;
                    // table "MsgInfo" already exists
                    if (ex.Message.IndexOf("already exists") == -1)
                    {
                        //throw ex;
                        if (SQLiteConn.OnSQLiteError != null)
                        {
                            SQLiteConn.OnSQLiteError(this, ex);
                        }
                    }
                }
            ...
            void MigrateTable(TableMapping map)
            {
                ...
                foreach (var p in toBeAdded)
                {
                    ...
                    catch (Exception ex)
                    {
                        if (SQLiteConn.OnSQLiteError != null)
                        {
                            SQLiteException sqlEx = new SQLiteException(addCol + " -> " + ex.Message);

                            SQLiteConn.OnSQLiteError(this, sqlEx);
                        }
                    }                    
                }
            }
            ...
            public SQLiteCommand CreateCommand(string cmdText, params object[] ps)
            {
                ...
                {
                    var cmd = new SQLiteCommand(cmdText, this.Connection);
            ...
            {
                var cmd = CreateCommand(query, args);
                return cmd.ExecuteQuery<T>(this.GetMapping(typeof(T)));
            }
            ...
            public int Insert(object obj, string extra, Type objType)
            {
                ...
                var count = insertCmd.ExecuteNonQuery(vals);// insertCmd.ExecuteNonQuery(vals);

                if (map.HasAutoIncPK)
                {
                    var id = this.Connection.LastInsertRowId; //SQLite3.LastInsertRowid(Handle);
            ...
            ///// <returns></returns>
            //public int Save(object obj, Type objType)
            //{
            //    if (obj == null || objType == null)
            //    {
            //        return 0;
            ...
            //    if (pk == null)
            //    {
            //        throw new NotSupportedException("Cannot Save " + map.TableName + ": it has no PK");
            //    }
            ...
            //    var  insertSql = string.Format("insert  into \"{0}\"({1}) values ({2})", map.TableName, string.Join(",", (from c in cols
        ...
        public class TableMapping
        {
            ...
            public SQLiteCommand/* PreparedSqlLiteInsertCommand*/ GetInsertCommand(SQLiteConn conn, string extra)
            {
                if (_insertCommand == null || _insertCommandExtra != extra)
                {
                    var insertSql = InsertSql(extra);
                    _insertCommand = new SQLiteCommand(conn.Connection);// PreparedSqlLiteInsertCommand(conn);
            ...
            public class PropColumn : Column
            {
                ...
                {
                    _prop.SetValue(obj, Convert.ChangeType(val, (Nullable.GetUnderlyingType(_prop.PropertyType) ?? _prop.PropertyType)), null);
        ...
        //    internal SQLiteCommand(SQLiteConn conn)
        //    {
        //        _conn = conn;
        ...
        //            {
        //                SQLite3.BindUText(stmt, index, (string)value, -1, NegativePointer);
        //            }
        ...
        //    protected SQLiteConn Connection { get; set; }

        //    public string CommandText { get; set; }

        //    protected IntPtr Statement { get; set; }

        //    internal PreparedSqlLiteInsertCommand(SQLiteConn conn)
        //    {
        //        Connection = conn;
        //    }
        ...
        {
            public SQLiteConn Connection { get; private set; }
            ...
            TableQuery(SQLiteConn conn, TableMapping table)
            {
                Connection = conn;
                Table = table;
            }

            public TableQuery(SQLiteConn conn)
            {
                Connection = conn;
            ...
            {
                return GenerateCommand("*").ExecuteQuery<T>(this.Connection.GetMapping(typeof(T))).GetEnumerator();
            }
        ...
        //    {
        //        if ("64".Equals(Utils.Detect32or64()))
        //        {
        //            return SQLite3x64.Open(filename, out db);
        //        }
        //        return SQLite3x86.Open(filename, out db);
        //    }
        ...
        //        if ("64".Equals(Utils.Detect32or64()))
        //        {
        //            return SQLite3x64.Close(db);
        //        }
        //        return SQLite3x86.Close(db);
        //    }
        ...
        //        if ("64".Equals(Utils.Detect32or64()))
        //        {
        //            return SQLite3x64.Config(option);
        //        }
        //        return SQLite3x86.Config(option);
        //    }
        ...
        //        if ("64".Equals(Utils.Detect32or64()))
        //        {
        //            return SQLite3x64.BusyTimeout(db, milliseconds);
        //        }
        //        return SQLite3x86.BusyTimeout(db, milliseconds);
        //    }
        ...
        //        if ("64".Equals(Utils.Detect32or64()))
        //        {
        //            return SQLite3x64.Changes(db);
        //        }
        //        return SQLite3x86.Changes(db);
        //    }
        ...
        //        if ("64".Equals(Utils.Detect32or64()))
        //        {
        //            return SQLite3x64.Prepare2(db, sql, numBytes, out stmt, pzTail);
        //        }
        //        return SQLite3x86.Prepare2(db, sql, numBytes, out stmt, pzTail);
        //    }
        ...
        //        if ("64".Equals(Utils.Detect32or64()))
        //        {
        //            return SQLite3x64.Step(stmt);
        //        }
        //        return SQLite3x86.Step(stmt);
        //    }
        ...
        //        if ("64".Equals(Utils.Detect32or64()))
        //        {
        //            return SQLite3x64.Reset(stmt);
        //        }
        //        return SQLite3x86.Reset(stmt);
        //    }
        ...
        //        if ("64".Equals(Utils.Detect32or64()))
        //        {
        //            return SQLite3x64.Finalize(stmt);
        //        }
        //        return SQLite3x86.Finalize(stmt);
        //    }
        ...
        //        if ("64".Equals(Utils.Detect32or64()))
        //        {
        //            return SQLite3x64.LastInsertRowid(db);
        //        }
        //        return SQLite3x86.LastInsertRowid(db);
        //    }
        ...
        //        if ("64".Equals(Utils.Detect32or64()))
        //        {
        //            return SQLite3x64.Errmsg(db);
        //        }
        //        return SQLite3x86.Errmsg(db);
        //    }
        ...
        //        if ("64".Equals(Utils.Detect32or64()))
        //        {
        //            return SQLite3x64.BindParameterIndex(stmt, name);
        //        }
        //        return SQLite3x86.BindParameterIndex(stmt, name);
        //    }
        ...
        //        if ("64".Equals(Utils.Detect32or64()))
        //        {
        //            return SQLite3x64.BindNull(stmt, index);
        //        }
        //        return SQLite3x86.BindNull(stmt, index);
        //    }
        ...
        //        if ("64".Equals(Utils.Detect32or64()))
        //        {
        //            return SQLite3x64.BindInt(stmt, index, val);
        //        }
        //        return SQLite3x86.BindInt(stmt, index, val);
        //    }
        ...
        //        if ("64".Equals(Utils.Detect32or64()))
        //        {
        //            return SQLite3x64.BindInt64(stmt, index, val);
        //        }
        //        return SQLite3x86.BindInt64(stmt, index, val);
        //    }
        ...
        //        if ("64".Equals(Utils.Detect32or64()))
        //        {
        //            return SQLite3x64.BindDouble(stmt, index, val);
        //        }
        //        return SQLite3x86.BindDouble(stmt, index, val);
        //    }
        ...
        //        if ("64".Equals(Utils.Detect32or64()))
        //        {
        //            return SQLite3x64.BindText(stmt, index, val, n, free);
        //        }
        //        return SQLite3x86.BindText(stmt, index, val, n, free);
        //    }

        //    public static int BindUText(IntPtr db, int num, string zSql, int nByte, IntPtr fp)
        //    {
        //        if ("64".Equals(Utils.Detect32or64()))
        //        {
        //            return SQLite3x64.BindUText(db, num, zSql, nByte, fp);
        //        }
        //        return SQLite3x86.BindUText(db, num, zSql, nByte, fp);
        //    }
        ...
        //        if ("64".Equals(Utils.Detect32or64()))
        //        {
        //            return SQLite3x64.BindBlob(stmt, index, val, n, free);
        //        }
        //        return SQLite3x86.BindBlob(stmt, index, val, n, free);
        //    }
        ...
        //        if ("64".Equals(Utils.Detect32or64()))
        //        {
        //            return SQLite3x64.ColumnCount(stmt);
        //        }
        //        return SQLite3x86.ColumnCount(stmt);
        //    }
        ...
        //        if ("64".Equals(Utils.Detect32or64()))
        //        {
        //            return SQLite3x64.ColumnName(stmt, index);
        //        }
        //        return SQLite3x86.ColumnName(stmt, index);
        //    }
        ...
        //        if ("64".Equals(Utils.Detect32or64()))
        //        {
        //            return SQLite3x64.ColumnName16(stmt, index);
        //        }
        //        return SQLite3x86.ColumnName16(stmt, index);
        //    }
        ...
        //        if ("64".Equals(Utils.Detect32or64()))
        //        {
        //            return SQLite3x64.ColumnType(stmt, index);
        //        }
        //        return SQLite3x86.ColumnType(stmt, index);
        //    }
        ...
        //        if ("64".Equals(Utils.Detect32or64()))
        //        {
        //            return SQLite3x64.ColumnInt(stmt, index);
        //        }
        //        return SQLite3x86.ColumnInt(stmt, index);
        //    }
        ...
        //        if ("64".Equals(Utils.Detect32or64()))
        //        {
        //            return SQLite3x64.ColumnInt64(stmt, index);
        //        }
        //        return SQLite3x86.ColumnInt64(stmt, index);
        //    }
        ...
        //        if ("64".Equals(Utils.Detect32or64()))
        //        {
        //            return SQLite3x64.ColumnDouble(stmt, index);
        //        }
        //        return SQLite3x86.ColumnDouble(stmt, index);
        //    }
        ...
        //        if ("64".Equals(Utils.Detect32or64()))
        //        {
        //            return SQLite3x64.ColumnText(stmt, index);
        //        }
        //        return SQLite3x86.ColumnText(stmt, index);
        //    }
        ...
        //        if ("64".Equals(Utils.Detect32or64()))
        //        {
        //            return SQLite3x64.ColumnText16(stmt, index);
        //        }
        //        return SQLite3x86.ColumnText16(stmt, index);
        //    }
        ...
        //        if ("64".Equals(Utils.Detect32or64()))
        //        {
        //            return SQLite3x64.ColumnBlob(stmt, index);
        //        }
        //        return SQLite3x86.ColumnBlob(stmt, index);
        //    }
        ...
        //        if ("64".Equals(Utils.Detect32or64()))
        //        {
        //            return SQLite3x64.ColumnBytes(stmt, index);
        //        }
        //        return SQLite3x86.ColumnBytes(stmt, index);
        //    }
        ...
        //    [DllImport(DLL_NAME, EntryPoint = "sqlite3_open16", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        //    public static extern Result Open(string filename, out IntPtr db);

        //    [DllImport(DLL_NAME, EntryPoint = "sqlite3_close")]
        //    public static extern Result Close(IntPtr db);

        //    [DllImport(DLL_NAME, EntryPoint = "sqlite3_config")]
        //    public static extern Result Config(ConfigOption option);

        //    [DllImport(DLL_NAME, EntryPoint = "sqlite3_busy_timeout")]
        //    public static extern Result BusyTimeout(IntPtr db, int milliseconds);

        //    [DllImport(DLL_NAME, EntryPoint = "sqlite3_changes")]
        //    public static extern int Changes(IntPtr db);

        //    [DllImport(DLL_NAME, EntryPoint = "sqlite3_prepare_v2")]
        ...
        //    [DllImport(DLL_NAME, EntryPoint = "sqlite3_step")]
        //    public static extern Result Step(IntPtr stmt);

        //    [DllImport(DLL_NAME, EntryPoint = "sqlite3_reset")]
        //    public static extern Result Reset(IntPtr stmt);

        //    [DllImport(DLL_NAME, EntryPoint = "sqlite3_finalize")]
        //    public static extern Result Finalize(IntPtr stmt);

        //    [DllImport(DLL_NAME, EntryPoint = "sqlite3_last_insert_rowid")]
        //    public static extern long LastInsertRowid(IntPtr db);

        //    [DllImport(DLL_NAME, EntryPoint = "sqlite3_errmsg16")]
        ...
        //    [DllImport(DLL_NAME, EntryPoint = "sqlite3_bind_parameter_index")]
        //    public static extern int BindParameterIndex(IntPtr stmt, string name);

        //    [DllImport(DLL_NAME, EntryPoint = "sqlite3_bind_null")]
        //    public static extern int BindNull(IntPtr stmt, int index);

        //    [DllImport(DLL_NAME, EntryPoint = "sqlite3_bind_int")]
        //    public static extern int BindInt(IntPtr stmt, int index, int val);

        //    [DllImport(DLL_NAME, EntryPoint = "sqlite3_bind_int64")]
        //    public static extern int BindInt64(IntPtr stmt, int index, long val);

        //    [DllImport(DLL_NAME, EntryPoint = "sqlite3_bind_double")]
        //    public static extern int BindDouble(IntPtr stmt, int index, double val);

        //    [DllImport(DLL_NAME, EntryPoint = "sqlite3_bind_text")]
        ...
        //    public static extern int BindUText(IntPtr db, int num, string zSql, int nByte, IntPtr fp); 

        //    [DllImport(DLL_NAME, EntryPoint = "sqlite3_bind_blob")]
        //    public static extern int BindBlob(IntPtr stmt, int index, byte[] val, int n, IntPtr free);

        //    [DllImport(DLL_NAME, EntryPoint = "sqlite3_column_count")]
        //    public static extern int ColumnCount(IntPtr stmt);

        //    [DllImport(DLL_NAME, EntryPoint = "sqlite3_column_name")]
        //    public static extern IntPtr ColumnName(IntPtr stmt, int index);

        //    [DllImport(DLL_NAME, EntryPoint = "sqlite3_column_name16")]
        //    public static extern IntPtr ColumnName16(IntPtr stmt, int index);

        //    [DllImport(DLL_NAME, EntryPoint = "sqlite3_column_type")]
        //    public static extern ColType ColumnType(IntPtr stmt, int index);

        //    [DllImport(DLL_NAME, EntryPoint = "sqlite3_column_int")]
        //    public static extern int ColumnInt(IntPtr stmt, int index);

        //    [DllImport(DLL_NAME, EntryPoint = "sqlite3_column_int64")]
        //    public static extern long ColumnInt64(IntPtr stmt, int index);

        //    [DllImport(DLL_NAME, EntryPoint = "sqlite3_column_double")]
        //    public static extern double ColumnDouble(IntPtr stmt, int index);

        //    [DllImport(DLL_NAME, EntryPoint = "sqlite3_column_text")]
        //    public static extern IntPtr ColumnText(IntPtr stmt, int index);

        //    [DllImport(DLL_NAME, EntryPoint = "sqlite3_column_text16")]
        //    public static extern IntPtr ColumnText16(IntPtr stmt, int index);

        //    [DllImport(DLL_NAME, EntryPoint = "sqlite3_column_blob")]
        //    public static extern IntPtr ColumnBlob(IntPtr stmt, int index);

        //    //[DllImport(DLL_NAME, EntryPoint = "sqlite3_column_bytes")]
